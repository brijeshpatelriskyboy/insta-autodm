...
import metaTestDmFailureSimRoutes from "./routes/metaTestDmFailureSim.routes";
...
export function createApp() {
  ...
  // TEMPORARY — DM failure simulation probe; remove after one verification call.
  app.use("/api/meta-test", metaTestDmFailureSimRoutes);
